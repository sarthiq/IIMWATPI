...
export const EntranceTestDetails = () => {
    ...
    const tabs = [
        { id: "intermediate", label: "Intermediate", component: <IntermediateExam />, path: "intermediate" },
        { id: "graduation", label: "Graduation", component: <GraduationExam />, path: "graduation" },
        { id: "after-graduation", label: "After Graduation", component: <AfterGraduation />, path: "after-graduation" }
    ];
            ...
            >
                ...
                <Tab.Content>
                    <Routes>
                        ...
                        <Route
                            path="/"
                            element={<Navigate to="intermediate" replace />}
                        />
                    </Routes>
                </Tab.Content>
            </Tab.Container>
