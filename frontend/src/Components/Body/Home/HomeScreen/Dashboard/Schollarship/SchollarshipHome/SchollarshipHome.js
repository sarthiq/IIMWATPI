...
export const SchollarshipHome = () => {
    ...
    const scholarships = [
        {
            ...
            description: "Central government scholarship for undergraduate and postgraduate students",
        ...
        },
        {
            ...
            description: "Financial assistance for disadvantaged students pursuing higher education",
            applyLink: "https://scholarships.gov.in/",
        ...
        },
        {
            ...
            eligibility: "Students pursuing undergraduate studies with academic excellence",
            deadline: "September 15, 2024",
            provider: "Tata Trusts",
            category: "Social Foundations",
            description: "Merit-based scholarship for promising undergraduate students",
        ...
        },
        {
            ...
            eligibility: "Students from minority communities pursuing professional courses",
            ...
            scholarships: [
                {
                    ...
                    eligibility: "Students from EBC families with annual income below 8 lakhs",
                    deadline: "November 30, 2024",
                    provider: "Government of Maharashtra",
                    description: "Merit-based scholarship for economically backward class students",
            ...
            scholarships: [
                {
                    ...
                    description: "Comprehensive scholarship for technical and professional courses",
                ...
                },
                {
                    ...
                    eligibility: "Engineering and medical students from low-income families",
                    deadline: "November 30, 2024",
                    provider: "Gujarat Education Department",
                    description: "Support for food expenses during professional education",
            ...
            scholarships: [
                {
                    ...
                    description: "Comprehensive scholarship for general category students",
                ...
                },
                {
                    ...
                    description: "Free coaching and scholarship for competitive exam preparation",
            ...
            scholarships: [
                {
                    ...
                    description: "Education loan and scholarship support for higher studies",
                ...
                },
                {
                    ...
                    description: "Financial assistance for girl students pursuing higher education",
            ...
            scholarships: [
                {
                    ...
                    description: "Comprehensive scholarship scheme for various categories",
        ...
        },
        {
            ...
            scholarships: [
                ...
                },
                {
                    ...
                    eligibility: "Students from families with annual income below 2.5 lakhs",
                    deadline: "November 30, 2024",
            ...
            scholarships: [
                {
                    ...
                    eligibility: "College students with annual family income below 2 lakhs",
                    deadline: "September 30, 2024",
            ...
            scholarships: [
                {
                    ...
                    description: "Special scholarship for J&K students in professional courses",
    ...
    return (
        <Container className="scholarship-container py-5">
            <h2 className="scholarship-title text-center mb-4">Available Scholarships in India</h2>
            <Row className="g-4">
            ...
            <h2 className="scholarship-title text-center mt-5 mb-4">State-Wise Scholarships</h2>
